...
#define list_del_init(n) do { \
	list_del(n); \
	list_head_init(n); } while (0)
...
extern void event_init(struct event *e, struct event_base *base,
		int fd, short ev_event, callback cb, void *args);
