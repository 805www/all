...
static inline bool list_is_first(struct list_head *list, struct list_head *head)
{
	return list->prev = head;
}

static inline bool list_is_last(struct list_head *list, struct list_head *head)
{
...
static inline bool list_is_head(struct list_head *list, struct list_head *head)
{
	return list == head;
}
